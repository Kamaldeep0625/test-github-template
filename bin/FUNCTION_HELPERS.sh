...
# AUTHOR:        @Kamaldeep9625 | Kamaldeep Singh
...
# LICENSE:       see in ../LICENSE (project root) or https://github.com/Kamaldeep9625/github-template/blob/master/LICENSE
# GITHUB:        https://github.com/Kamaldeep9625/
# REPOSITORY:    https://github.com/Kamaldeep9625/github-template
# ISSUES:        https://github.com/Kamaldeep9625/github-template/issues
# MAIL:          kamaldeep0625dev@gmail.com
#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#
...
displayTestErrorTexts() {
  ...
  echo -e "Remember that your brand new repository should be created from here: ${BOLD}${UPURPLE}https://github.com/Kamaldeep9625/project-template/generate${NC}"
...
displayHelpTexts() { # (it will manually detect your git data and prompt for the proejct type)
  ...
  echo -e "  bash $0 -u=Kamaldeep9625 --projectType=Github-template --omit-commit${NC}\n"

  echo -e "The username, project-name and email are automatically gathered from your git repository and git config."
  echo -e "Make sure you have ${BBLUE}read the documentation before executing${NC} this script: ${UPURPLE}https://github.com/Kamaldeep9625/project-template${NC}"
  echo -e "If you have any questions or if any issue is found, please make sure to report it at: ${UPURPLE}https://github.com/Kamaldeep9625/project-template/issues${NC}"
}
...
$PROJECT_NAME was generated from *[Kamaldeep9625/project-template](https://github.com/Kamaldeep9625/project-template)* 📚
...
* The basic project structure from **[Kamaldeep9625/github-template](https://github.com/Kamaldeep9625/github-template)**.
EOF"
}
