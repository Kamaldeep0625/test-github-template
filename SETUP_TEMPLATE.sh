...
# PURPOSE:       Shell script that setups the @Kamaldeep0625/github-template github project template.
...
# LICENSE:       see in LICENSE (project root) or https://github.com/Kamaldeep0625/github-template/blob/master/LICENSE
# GITHUB:        https://github.com/Kamaldeep0625/
# REPOSITORY:    https://github.com/Kamaldeep0625/github-template
# ISSUES:        https://github.com/Kamaldeep0625/github-template/issues
...
echo -e "Thanks for using ${GREEN}@Kamaldeep0625/github-template${NC}"
echo -e "Read carefully all the documentation before you continue executing this script: ${UPURPLE}https://github.com/Kamaldeep0625/github-template${NC}\n"
...
y | Y)
  ...
  find .github/ -type f -name "*" -print0 | xargs -0 sed -i "s/Kamaldeep0625/${NEW_USERNAME}/g"
  find .github/ -type f -name "*" -print0 | xargs -0 sed -i "s/jgracia9988@gmail.com/${NEW_EMAIL}/g"
  find .github/ -type f -name "*" -print0 | xargs -0 sed -i "s/github-template/${PROJECT_NAME}/g"
  find .gitignore -type f -name "*" -print0 | xargs -0 sed -i "s/Kamaldeep0625\/github-template/${NEW_USERNAME}\/${PROJECT_NAME}/g"
  ...
  if [ $will_omit_commit = false ]; then                                                  # if the ignore option for tests has been specified
    ...
    git commit -m "Set up '@Kamaldeep0625/github-template' template: Personalized files by executing the SETUP_TEMPLATE.sh script.🚀"
